lib.callback.register('hw_garage:getContractOption', function()
...
lib.callback.register('hw_garage:getTargetPlayer', function()
...
lib.callback.register('hw_garage:getAgreement', function(price, label, name)
...
lib.callback.register('hw_garage:societyPrompt', function(type)
    local result = lib.alertDialog({
...
RegisterNetEvent('hw_garage:contractAnim', function(message)
    lib.progressBar({
        label = message,
